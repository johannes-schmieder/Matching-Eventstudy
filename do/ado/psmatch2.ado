*! version 4.0.6 17may2012 E. Leuven, B. Sianesi
program define psmatch2, sortpreserve
	...
	// generate output
	_mktab `outcome', `ate' `spline' `llr' k(`kerneltype') ai(`ai') n(`neighbor') `population' exog(`varlist')
...
syntax [varlist(default=none)] [, ate spline llr Kerneltype(string) ai(integer 0) Neighbor(integer 1) population exog(varlist)]
