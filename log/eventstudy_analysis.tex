...
Standard errors are clustered at the matched pair level (Abadie and Spiess, 2022).
\begin{figure}[H] 
\centering 
...
Panels (e)--(g) use hollow circles at the omitted category. Scaled outcomes are undefined (division by zero)
and Poisson coefficients are not identified for groups where outcomes are precise zeros.
...
\bibitem{AbadieSpiess2022}
Abadie, Alberto and Jann Spiess (2022).
\textit{Robust Post-Matching Inference.}
